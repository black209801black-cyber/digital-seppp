...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ رو وارد کن ( حروف انگیلیسی توجه توجه(((❌❌حروف کوچک❌❌))) و عدد باهم وارد کنید )',
...
",
    ...
    'start_message'=>'سلااام به ربات دیجیتال اینفرنو خوش اومدی 🫡🌸
...
$buttonValues = [
    ...
    'woocommerce_gateway' => "💳 خرید با درگاه ریالی",
    'approve' => 'تایید ✅',
    'approved' => 'تایید شد',
    'decline' => 'عدم تایید ❌',
    'declined' => 'رد شد',
