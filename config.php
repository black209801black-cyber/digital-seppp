...
function getMainKeys(){
    ...
    $inviteAndInfoRow = [];
    if ($botState['inviteFriends'] != "off" && $userInfo['is_agent'] != 1) {
        $inviteAndInfoRow[] = ['text'=>$buttonValues['invite_friends'],'callback_data'=>"inviteFriends"];
    }
    $inviteAndInfoRow[] = ['text'=>$buttonValues['my_info'],'callback_data'=>"myInfo"];
...
function getGateWaysKeys(){
    ...
    $woocommerceGatewayState = $botState['woocommerceGatewayState']=="on"?$buttonValues['on']:$buttonValues['off']; 
    ...
    return json_encode(['inline_keyboard'=>[
        ...
        [
            ['text'=>$woocommerceGatewayState,'callback_data'=>"changeGateWayswoocommerceGatewayState"],
            ['text'=>"درگاه ووکامرس (ریالی)",'callback_data'=>"wizwizch"]
        ],
        [
...
function getBotSettingKeys(){
    ...
    $volumeWeb = $botState['volumeWebState']=="on"?$buttonValues['on']:$buttonValues['off'];
    ...
    return json_encode(['inline_keyboard'=>[
        ...
        [
            ...
            ['text'=>"لینک حجم وب",'callback_data'=>"wizwizch"]
        ],
        [
